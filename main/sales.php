...
<option></option>
	...
	?>
		<option value="<?php echo $row['product_id'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Caducidad: <?php echo $row['expiry_date']; ?></option>
	<?php
				}
			?>
</select>
