...
<?php
			...
			Total numero de proveedores: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("¿Está seguro de querer Borrar registro de Proveedor? Esta acción No puede deshacerse!"))
		  {
