...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Atras</button></a>
			...
			Total Numero de Productos:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>

			<div style="text-align:center;">
			<font style="color:rgb(255, 95, 66);; font:bold 22px 'Aleo';">[<?php echo $rowcount123;?>]</font> Productos abajo de 10
			</div>
</div>


<input type="text" style="padding:15px;" name="filter" value="" id="filter" placeholder="Buscar Productos..." autocomplete="off" />
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				if ($availableqty < 10) {
				echo '<tr class="alert alert-warning record" style="color: #fff; background:rgb(255, 189, 66);">';
				}
				else {
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("¿Seguro que deseas borrar este producto? Esta acción NO se puede deshacer!"))
		  {
