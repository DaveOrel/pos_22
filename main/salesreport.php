...
<button  style="float:right;" class="btn btn-success btn-medium"><a href="javascript:Clickheretoprint()"> Imprimir</button></a>
...
<div style="font-weight:bold; text-align:center;font-size:14px;margin-bottom: 15px;">
	<div> SOLUCIONES WEB - POS</div>
Reporte de ventas del&nbsp;<?php echo $_GET['d1'] ?>&nbsp;al &nbsp;<?php echo $_GET['d2'] ?>
</div>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="18%"> Ventas reportadas </th>
			<th width="13%"> Rentabilidad</th>
		</tr>
	</thead>
	<tbody>
...
//Built a url to send
var info = 'id=' + del_id;
 if(confirm("Seguro que quieres borrar? Esta opción No puede deshacerse!"))
		  {
