...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="customer.php"><i class="icon fas fa-user-clock icon-2x"></i> Clientes</a>                                    </li>
			<li><a href="supplier.php"><i class="icon-group icon-2x"></i> Proveedores</a>                                    </li>
			<li><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Reporte ventas</a>
      <li><a href="help.php"><i class="icon fas fa-ambulance icon-2x"></i></i>  Ayuda</a>               </li>
			<br><br><br><br><br><br>
			<li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Soluciones Web - POS</center></font>
<div id="mainmain">
