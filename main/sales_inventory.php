...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="sales_inventory.php"><i class="icon-table icon-2x"></i> Inventario de productos</a>                </li>
			<br><br><br><br><br><br>
			<li>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Inventario de productos
			</div>
<br>
...
<input type="text" style="padding:15px;" name="filter" value="" id="filter" placeholder="Buscar..." autocomplete="off" />
<div class="content" id="content">
<br><br><br>
<center><strong>Inventario de productos</strong></center>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="15%"> Categoria / Descripccion </th>
			<th > Precio </th>
			<th> QTY </th>
	...
	<tbody>
			...
			?></td>
			<td>
			<a href="deletesalesinventory.php?id=<?php echo $row['transaction_id']; ?>&qty=<?php echo $row['qty'];?>"><button class="btn btn-mini btn-danger"><i class="icon icon-trash"></i> Eliminar </button></a>
			</tr>
			<?php
				}
			?>
