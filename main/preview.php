...
<?php include('navfixed.php');?>
	...
	<div class="span10">
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> Ir a Ventas</button></a>
...
<div style="margin: 0 auto; padding: 40px; width: 900px; height: 900px; font-weight: normal; border-style: groove;">
	...
	<table border="1" cellpadding="5" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				?>
				<tr>
					<td colspan="4" style=" text-align:right;"><strong style="font-size: 12px; color: #222222;">Efectivo entregado $
&nbsp;</strong></td>
