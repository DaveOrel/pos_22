...
<center>
<input type="text" size="25" value="" name="cname" id="country" onkeyup="suggest(this.value);" onblur="fill();" class="" autocomplete="off" placeholder="Ingrese nombre del cliente" style="width: 268px; height:30px;" />
...
<input type="number" name="cash" placeholder="Efectivo" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/><br>
<?php
}
